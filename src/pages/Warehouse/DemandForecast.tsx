    ...
    const Form = () => {
        ...
        const processDataChange = (
            ...
            if (updatedCol) {
                updateRequestPayload.push({
                    id: warehouseState.demand_table_data[newRow.date][
                        updatedCol
                    ]['id'],
                    demand: updatedRow[updatedCol],
                })

                updatedTableData.some(
                    (payload: any) => payload.id === newRow.id,
                )
        ...
        const handleClickSave = () => {
            const tableData = JSON.parse(
                JSON.stringify(warehouseState.modified_demand_table_data),
            )
        ...
        const handleChange = (event: any) => {
            ...
            if (fileObj) {
                const context = {
                    ...
                    end_date: dayjs(warehouseState.planning_end_date).format(
                        'YYYY-MM-DD',
                    ),
                }
                dispatch(
        ...
        return (
            ...
            >
                ...
                >
                    ...
                    <Grid item lg={2}>
                        <Typography>
                            {warehouseState.demand_file_name}
                        </Typography>
                    </Grid>
                </Grid>
                ...
                >
                    {warehouseState.demand_table_cols &&
                        warehouseState.modified_demand_table_data && (
                            <FormDataGrid
